document.addEventListener("DOMContentLoaded", function () {
  ...
  const productsDropdownContainer = document.getElementById(
  ...
  if (productsDropdownContainer) {
    productsDropdownContainer.addEventListener("mouseenter", () => {
      if (window.innerWidth >= 1024) {
        if (productsDropdownMenu) {
          productsDropdownMenu.classList.remove(
            "opacity-0",
            "scale-95",
            "pointer-events-none"
          );
        }
        if (productsArrowIcon)
          productsArrowIcon.style.transform = "rotate(180deg)";
      }
    });
    ...
    productsDropdownContainer.addEventListener("mouseleave", () => {
      if (window.innerWidth >= 1024) {
        if (productsDropdownMenu) {
          productsDropdownMenu.classList.add(
            "opacity-0",
            "scale-95",
            "pointer-events-none"
          );
        ...
        if (productsArrowIcon)
          productsArrowIcon.style.transform = "rotate(0deg)";
      }
    });
  }
  ...
  const productsDropdownButton = document.querySelector(
    "#products-dropdown-button"
  );
  const homeLink = document.querySelector(
    '#main-nav a[href="http://emveemachinery.com"]'
  );
  ...
  const setActiveLinkOnLoad = () => {
    ...
    const productPages = [
      "two-post-stacker.html",
      "four-post-stacker.html",
      "puzzle-parking.html",
      "tower-parking.html",
    ...
    if (productPages.includes(currentPage)) {
      ...
      currentPage === "http://emveemachinery.com" ||
      currentPage === ""
    ) {
      ...
      activateLink(
        document.querySelector(
          '#main-nav a[href="http://emveemachinery.com#videos"]'
        )
      );
    } else if (currentPage.includes("#contact")) {
      activateLink(
        document.querySelector(
          '#main-nav a[href="http://emveemachinery.com#contact"]'
        )
      );
    } else if (currentPage.includes("#about")) {
      activateLink(
        document.querySelector(
          '#main-nav a[href="http://emveemachinery.com#about"]'
        )
      );
    }
  };
  ...
  const isHomePage =
    window.location.pathname.endsWith("http://emveemachinery.com") ||
    ...
    const onScroll = () => {
      ...
      if (currentSectionId === "products") {
        ...
        const activeLink = document.querySelector(
          `#main-nav a[href="#${currentSectionId}"]`
        );
        if (activeLink) {
